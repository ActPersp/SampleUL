# The scripts below run discounted cash flow model for a Plan.UL2 policy.
# This example illustrates how to incorporate flexible premium feature in UL modeling. 
# The model incorporates a premium persistency assumption which assumes a decreasing payment pattern.
...
saveWorkbook(wb, "export/UL4.xlsx", overwrite = TRUE)
